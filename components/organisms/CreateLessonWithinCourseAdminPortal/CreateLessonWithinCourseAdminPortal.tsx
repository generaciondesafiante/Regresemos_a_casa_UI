...
export const CreateLessonWithinCourseAdminPortal = () => {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    Swal.fire({
      ...
      text: "Vas a agregar el recurso a este tema",
      icon: "warning",
    ...
    <main className={styles["createCourse"]}>
      ...
      <form className={styles["createCourse__form"]} onSubmit={onSubmit}>
        ...
        <div className={styles["container__input"]}>
          ...
          <input
            type="text"
            value={selectedResourceData?.title || "Seleccionar Recurso"} // Muestra el título del recurso si se selecciona, o el placeholder
            readOnly
            className={styles.inputOptions}
            onClick={toggleModal}
          />
